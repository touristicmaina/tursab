...
var CAccordionBody = React.forwardRef(function (_a, ref) {
    ...
    var _b = React.useContext(CAccordionItemContext.CAccordionItemContext), id = _b.id, visible = _b.visible;
    return (React.createElement(CCollapse.CCollapse, { className: "accordion-collapse", id: id, visible: visible },
