...
var CSidebar = React.forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.as, Component = _c === void 0 ? 'div' : _c, className = _a.className, colorScheme = _a.colorScheme, narrow = _a.narrow, onHide = _a.onHide, onShow = _a.onShow, onVisibleChange = _a.onVisibleChange, overlaid = _a.overlaid, placement = _a.placement, position = _a.position, size = _a.size, unfoldable = _a.unfoldable, visible = _a.visible, rest = tslib_es6.__rest(_a, ["children", "as", "className", "colorScheme", "narrow", "onHide", "onShow", "onVisibleChange", "overlaid", "placement", "position", "size", "unfoldable", "visible"]);
    var sidebarRef = React.useRef(null);
    var forkedRef = useForkedRef.useForkedRef(ref, sidebarRef);
    var _d = React.useState(), inViewport = _d[0], setInViewport = _d[1];
    var _e = React.useState(false), mobile = _e[0], setMobile = _e[1];
    var _f = React.useState(false), visibleMobile = _f[0], setVisibleMobile = _f[1];
    var _g = React.useState(visible !== undefined ? visible : overlaid ? false : true), visibleDesktop = _g[0], setVisibleDesktop = _g[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Component, tslib_es6.__assign({ className: index.default('sidebar', (_b = {},
