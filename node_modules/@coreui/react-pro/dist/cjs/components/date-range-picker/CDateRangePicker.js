...
var utils$1 = require('../calendar/utils.js');
...
var CDateRangePicker = React.forwardRef(function (_a, ref) {
    ...
    var formatDate = function (date) {
        if (inputDateFormat) {
            return inputDateFormat(date instanceof Date ? new Date(date) : utils$1.convertToDateObject(date, selectionType));
        }
    ...
    var InputGroup = function () { return (React.createElement("div", { className: "date-picker-input-group" },
        React.createElement("input", tslib_es6.__assign({ autoComplete: "off", className: index.default('date-picker-input', {
            ...
            }), disabled: disabled }, (id && { id: utils.getInputIdOrName(id, range, 'start') }), (name && { name: utils.getInputIdOrName(name, range, 'start') }), (id &&
            !Array.isArray(id) &&
        ...
        range && (React.createElement("input", tslib_es6.__assign({ autoComplete: "off", className: index.default('date-picker-input', {
            ...
            }), disabled: disabled }, (id && { id: utils.getInputIdOrName(id, range, 'end') }), (name && { name: utils.getInputIdOrName(name, range, 'end') }), (id && !Array.isArray(id) && !name && { name: "".concat(id, "-end-date") }), { placeholder: placeholder[1], readOnly: inputReadOnly, required: required, onChange: function (event) {
